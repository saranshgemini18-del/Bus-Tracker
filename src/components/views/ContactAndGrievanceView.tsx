...
export const ContactAndGrievanceView: React.FC = () => {
  ...
  const handleSubmitGrievance = (e: React.FormEvent) => {
    e.preventDefault();
    if (!fullName || !mobileNumber || !description) {
      alert('Please fill all mandatory fields (Name, Mobile, Description).');
      return;
    }
    ...
    <div className="w-full min-h-[calc(100vh-80px)] bg-[#f8f9ff] py-8 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl bg-white border border-slate-200 shadow-sm">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-[#171c23] tracking-tight">
            Contact DTC & Grievance Redressal
          </h1>
          <p className="text-xs text-[#59413a] mt-1 font-medium">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="p-3 rounded-2xl bg-[#f0f4fd] border border-slate-200 text-center min-w-[130px]">
            <span className="text-xl font-black text-[#006d42]">94.2%</span>
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wide">Resolution SLA</p>
          </div>
          <div className="p-3 rounded-2xl bg-[#f0f4fd] border border-slate-200 text-center min-w-[130px]">
            <span className="text-xl font-black text-[#a83301]">28.4 Hrs</span>
            <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wide">Avg Turnaround</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            <div className="w-10 h-10 rounded-xl bg-[#ffdbd0] text-[#a83301] flex items-center justify-center font-bold mb-3">
              <span className="material-symbols-outlined">headset_mic</span>
            </div>
            <span className="text-[10px] uppercase font-bold text-slate-400">24x7 Commuter Toll-Free</span>
            <h3 className="font-extrabold text-[#171c23] text-lg mt-0.5">1800-11-8181</h3>
          ...
          <a
            href="tel:1800118181"
            className="mt-4 text-xs font-bold text-[#a83301] hover:underline flex items-center gap-1"
          >
        ...
        {/* Card 2 */}
        <div className="p-5 rounded-2xl bg-gradient-to-br from-pink-50 to-white border border-pink-200 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <span className="text-[10px] uppercase font-bold text-pink-700">Women & Commuter Safety</span>
            <h3 className="font-extrabold text-pink-950 text-lg mt-0.5">SOS 1091 / 112</h3>
          ...
          <a
            href="tel:1091"
            className="mt-4 text-xs font-bold text-pink-700 hover:underline flex items-center gap-1"
          >
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            <div className="w-10 h-10 rounded-xl bg-[#93f3ba] text-[#006d42] flex items-center justify-center font-bold mb-3">
              <span className="material-symbols-outlined">apartment</span>
            </div>
            <span className="text-[10px] uppercase font-bold text-slate-400">Headquarters</span>
            <h3 className="font-extrabold text-[#171c23] text-base mt-0.5">Scindia House, CP</h3>
            <p className="text-xs text-slate-500 mt-1">
              Central Control Command, K.G. Marg, Connaught Place, New Delhi - 110001.
            </p>
          </div>
          <span className="mt-4 text-xs font-bold text-[#006d42] flex items-center gap-1">
            <span>Open 09:30 - 18:00</span>
            <span className="w-2 h-2 rounded-full bg-[#006d42]"></span>
          </span>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            <div className="w-10 h-10 rounded-xl bg-cyan-100 text-[#1a637c] flex items-center justify-center font-bold mb-3">
              <span className="material-symbols-outlined">mail</span>
            </div>
            <span className="text-[10px] uppercase font-bold text-slate-400">Email Escalation</span>
            <h3 className="font-extrabold text-[#171c23] text-sm mt-0.5 break-all">
          ...
          <a
            ...
            className="mt-4 text-xs font-bold text-[#1a637c] hover:underline flex items-center gap-1"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <h2 className="text-xl font-black text-[#171c23] flex items-center gap-2">
              <span className="material-symbols-outlined text-[#a83301]">edit_note</span>
          ...
          {submittedToken ? (
            <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-center space-y-3">
              ...
              <h3 className="text-xl font-black text-[#006d42]">Grievance Formally Registered!</h3>
              <p className="text-xs text-slate-600 max-w-md mx-auto">
                Thank you for bringing this to our attention. Your official complaint reference token has been generated:
              </p>
              <div className="p-4 bg-white rounded-xl border border-emerald-300 font-mono text-xl font-black text-[#171c23] tracking-widest inline-block shadow-sm">
                {submittedToken}
              </div>
            ...
            <form onSubmit={handleSubmitGrievance} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 px-3.5 rounded-xl bg-[#f8f9ff] text-xs font-medium border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#a83301]"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      className="w-full h-11 px-3.5 rounded-r-xl bg-[#f8f9ff] text-xs font-medium border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#a83301]"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full h-11 px-3 rounded-xl bg-[#f8f9ff] text-xs font-bold text-slate-700 border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#a83301]"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Route Number</label>
                  <input
                    type="text"
                    value={routeNumber}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Date & Approx Time</label>
                  <input
                    type="datetime-local"
                    value={dateTime}
                    onChange={(e) => setDateTime(e.target.value)}
                    className="w-full h-11 px-3 rounded-xl bg-[#f8f9ff] text-xs font-medium border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#a83301]"
                  />
                </div>

                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Bus Stop / Landmark</label>
                  <input
                    type="text"
                    value={stopLocation}
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3.5 rounded-xl bg-[#f8f9ff] text-xs font-medium border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#a83301]"
                ></textarea>
              </div>
              ...
              <div className="flex items-start gap-2 pt-1">
                ...
                />
                <label htmlFor="declaration" className="text-[11px] text-slate-600 leading-tight cursor-pointer">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-base font-extrabold text-[#171c23] flex items-center gap-2">
              <span className="material-symbols-outlined text-[#006d42]">track_changes</span>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 h-10 px-3 rounded-xl bg-[#f8f9ff] text-xs font-bold border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#006d42]"
              />
              <button
                type="button"
            ...
            {trackedStatus && (
              <div className="mt-4 pt-4 border-t border-slate-100 space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-bold text-slate-700">Token: #{trackTokenInput}</span>
                ...
                <div className="relative pl-6 space-y-3.5 pt-1">
                  ...
                  <div className="relative flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-bold text-[#171c23]">Complaint Registered & Dispatched</p>
                  ...
                  <div className="relative flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-bold text-[#171c23]">Vehicle Telematics & GPS Analyzed</p>
                  ...
                  <div className="relative flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-bold text-amber-800">In Progress: Inquiry with Depot Manager</p>
                  ...
                  <div className="relative flex items-start gap-2 opacity-50">
                    <div className="absolute -left-6 w-5 h-5 rounded-full bg-slate-300"></div>
                    <div>
                      <p className="text-xs font-bold text-slate-500">Corrective Action & Closure Notice</p>
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-base font-extrabold text-[#171c23] flex items-center gap-2">
              <span className="material-symbols-outlined text-[#a83301]">call</span>
                ...
                return (
                  <div key={group.id} className="rounded-xl border border-slate-200 overflow-hidden">
                    <button
                      ...
                      className="w-full p-3 bg-slate-50 hover:bg-slate-100 flex items-center justify-between text-left text-xs font-bold text-slate-800 transition cursor-pointer"
                    >
                      ...
                      <div className="p-3 bg-white space-y-2 text-xs border-t border-slate-100">
                        {group.numbers.map((num, i) => (
                          <div key={i} className="flex items-center justify-between text-slate-700">
                            ...
                            <a
                              href={`tel:${num.phone}`}
                              className="font-mono font-bold text-[#a83301] hover:underline"
                            >
                              {num.phone}
                            </a>
                          </div>
          ...
          <div className="p-5 rounded-2xl bg-amber-50 border border-amber-200 text-amber-950 space-y-2">
            <div className="flex items-center gap-2 font-black text-xs">
              <span className="material-symbols-outlined text-[18px] text-amber-700">luggage</span>
